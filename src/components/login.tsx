      ...
      {!showRegister ?(
        ...
        <div className="z-50 flex h-[34.5rem] w-[54rem] justify-center rounded-[25px] bg-white opacity-100">
            ...
            <div className="ml-[2.3125rem] mt-[1.8rem] ">
                ...
                <input
                className="mt-[0.2rem] h-[2.5rem] w-[22.375rem] rounded-[7px] border-[1px] border-[#b17c3f] bg-white pl-[1.25rem] placeholder:text-[0.8rem] placeholder:font-light "
            ...
            {/* checkbox */}
            <div className="items-center ml-[2.3125rem] mt-[0.5rem] flex w-[22.375rem]">
                <input
                type="checkbox"
                id="checkbox1"
                className="
            ...
            <div className="ml-[2.3125rem] mt-[1.2rem] w-[22.375rem]">
                <button className="h-[2.5rem] w-[22.375rem] rounded-[7px] bg-[#B17C3F] text-[0.8rem] font-normal text-white">
                Login Now
                </button>
                ...
                <button onClick={() => setShowRegister(true)} className="mt-[0.2rem] text-[0.6rem] font-semibold underline underline-offset-1 ">
                    Register now
                </button>
                </div>
            </div>
            ...
            <div className="ml-[2.3125rem] mt-[0.5rem] w-[22.375rem]">
                ...
                <button className="flex h-[2rem] w-[7.375rem] items-center justify-center space-x-1 rounded-[7px] border border-[#B17C3F] bg-white">
                    ...
                    <p className="text-[0.5rem] font-normal text-black ">Google</p>
                </button>
                <button className="flex h-[2rem] w-[7.375rem] items-center justify-center space-x-1 rounded-[7px] border border-[#B17C3F] bg-white">
                    <svg
                    width="16"
                ...
                <button className="flex h-[2rem] w-[7.375rem] items-center justify-center space-x-1 rounded-[7px] border border-[#B17C3F] bg-white">
                    ...
                    <p className="text-[0.5rem] font-normal text-black ">Twitter</p>
                </button>
                </div>
            </div>
            </div>
        ...
        <div className="z-50 flex h-[34.5rem] w-[54rem] justify-center rounded-[25px] bg-white opacity-100">
            ...
            <div className="ml-[2.3125rem] mt-[1rem] w-[22.375rem] ">
                <p className="text-[0.625rem] font-normal text-[#B17C3F]">Email</p>
                <input
                type="email"
                className="mt-[0.2rem] h-[2.5rem] w-[22.375rem] rounded-[7px] border-[1px] border-[#b17c3f] bg-white pl-[1.25rem] placeholder:text-[0.8rem] placeholder:font-light "
                placeholder="Email"
            ...
            <div className="ml-[2.3125rem] mt-[1rem] flex w-[22.375rem] justify-between ">
                ...
                <input
                    type="password"
                    className="mt-[0.2rem] h-[2.5rem] w-[10.875rem] rounded-[7px] border-[1px] border-[#b17c3f] bg-white pl-[1.25rem] placeholder:text-[0.8rem] placeholder:font-light "
                    placeholder="Password"
                />
                </div>
                <div>
            ...
            <div className="ml-[2.3125rem] mt-[0.5rem] w-[22.375rem]">
                <p className="w-full leading-3 text-[0.625rem] font-normal text-[#B17C3F]">
            ...
            {/* checkbox */}
            <div className="items-center ml-[2.3125rem] mt-[0.3rem] flex w-[22.375rem]">
                <input
                type="checkbox"
                id="checkbox1"
                className="
            ...
            <div className="ml-[2.3125rem] mt-[0.6rem] w-[22.375rem]">
                ...
                <button onClick={() => setShowRegister(false)} className="mt-[0.2rem] text-[0.6rem] font-semibold underline underline-offset-1 ">
                    Login now
                </button>
                </div>
            </div>
