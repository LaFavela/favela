          ...
          <div className="flex w-[39.5rem] justify-between ">
                ...
                >
                  ...
                  <div className="ml-2 w-[9.0625rem]">
                    <div className="flex w-full items-center justify-between ">
                      <p className="text-[0.625rem] font-light">Ramadhani</p>
                      <p className="text-[0.375rem] font-light">12.00</p>
                    </div>
                    <p className="truncate text-[0.5rem] font-extralight ">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Omnis quibusdam ullam vitae vero reprehenderit repellendus
                      veniam corporis ipsa pariatur quasi vel aspernatur eaque
                      asperiores error nostrum dignissimos rem, voluptas optio.
                    </p>
                  </div>
                </div>
              ))}
            ...
            <div className="h-[25rem] w-[25.125rem] rounded-[0.5rem] bg-white drop-shadow">
              <div className="mt-3 flex items-center border-b-2 border-gray-300 pb-2">
                ...
                <p className=" ml-3 text-[1rem] font-normal">Ramadhani</p>
              </div>
              <div className="h-[17.7rem] w-[22.5625rem]"></div>
