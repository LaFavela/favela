...
interface Props extends Properti {
...
export const getServerSideProps: GetServerSideProps<{ data: Props }> = async (
   ...
   const data = await useGet("/properti" + context.params?.id, {});
   return {
      props: {
         data,
      },
      ...
      <div>
         <div className="">
            ...
            <div className="mt-10 grid grid-cols-2 gap-5">
               {data.sarana.map((infrastructure, idx) => {
                  return (
                     <div key={idx}>
                        <div className="flex">
                           <ArrowLogo />
                           <span className="text-xly ml-5">
                              {infrastructure}
                           </span>
                        </div>
                     </div>
         ...
         <div id="details" className="">
            ...
            <div className="flex flex-row space-x-20">
               <div className="flex w-6/12 flex-col space-y-2 pt-9">
                  ...
                  <p className="text-lg font-medium">
                     {data.Detail_product.pengembang}
                  </p>
                  <div className="relative flex flex-col space-y-3 rounded-full border-b-2"></div>
               </div>
               <div className="flex w-6/12 flex-col space-y-2 pt-9">
            ...
            <div className="flex flex-row space-x-20">
               <div className="flex w-6/12 flex-col space-y-2 pt-9">
                  ...
                  <p className="text-lg font-medium">
                     {data.Detail_product.sertifikat}
                  </p>
                  <div className="relative flex flex-col space-y-3 rounded-full border-b-2"></div>
               </div>
               <div className="flex w-6/12 flex-col space-y-2 pt-9">
                  ...
                  <p className="text-lg font-medium">2 Jam yang Lalu</p>
                  <div className="relative flex flex-col space-y-3 rounded-full border-b-2"></div>
               </div>
            </div>
            <div className="flex flex-row space-x-20">
      ...
      <div>
         <div className="">
            ...
            <div className="mt-14 h-[80vh] w-full overflow-hidden rounded-3xl ">
               <Map
                  lat={parseFloat(data.posisi[0].toString())}
                  lng={parseFloat(data.posisi[1].toString())}
               ></Map>
            </div>
         </div>
      </div>
...
export default function Product({ data }: StaticProps) {
                           ...
                           <div>
                              ...
                              <div className="ml-10 mt-5">
                                 ...
                                 <span className="text-2xl font-medium">
                                    {data.Detail_product.harga.toString()}
                                 </span>
                              </div>
         ...
         <div>
            <div className="h-max rounded-full">
               {isRentSuccessful ? (
                  ...
                  <Popup
                     trigger={
                        <button className="button-grey w-[8rem]">Rent</button>
                     }
                     modal
                     nested
                           ...
                           <div>
                              ...
                              <div className="ml-10 mt-5">
                                 ...
                                 {selectedOption === "Year" ? (
                                    <span className="text-2xl font-medium">
                                       {parseFloat(
                                          data.Detail_product.hargaSewa.toString()
                                       ) * 12}
                                    </span>
   ...
   useEffect(() => {
      const handleScroll = () => {
         ...
         if (scrollPosition < detailsRef.current!.offsetTop - navHeight) {
            ...
            scrollPosition >=
               infrastructureRef.current!.offsetTop - navHeight &&
            ...
            scrollPosition >=
            reviewRef.current!.offsetTop - navHeight
         ) {
         ...
         <div className="flex-warp flex flex-col space-y-5 p-12">
            ...
            <div className="flex space-x-10">
               ...
               <div className="flex h-min w-[45%] flex-col">
                  ...
                  <p className="mt-3 text-[1.75rem] font-medium">
                     {data.namaProduk}
                  </p>
                  ...
                  <div className="mt-4 flex flex-row items-center space-x-3 text-sm">
                     ...
                     <p>{data.Detail_product.jumlah_kamar} Bedrooms</p>
                     <svg
                        width="20"
                        height="20"
                        viewBox="0 0 20 20"
                     ...
                     <p>{data.Detail_product.jumlah_kamarMandi} Showers</p>
                     <svg
                        width="19"
                        height="18"
                        viewBox="0 0 19 18"
                  ...
                  <p className="my-10 text-2xl font-light">{data.deskripsi}</p>
            ...
            <div className="flex flex-col space-y-1">
               ...
               >
                  <div className="flex flex-row text-center text-xl text-[#D0D0D0]">
                     ...
                     >
                        <button
                           onClick={() =>
                              scrollToSection(detailsRef, "details")
                           }
                        >
                           Detail
                        </button>
               ...
               <div className="flex flex-col space-y-10 px-24 pt-9">
                  <div ref={detailsRef}>{<Details {...data} />}</div>
                  <div ref={infrastructureRef}>
                     {<Infrastructure {...data} />}
                  </div>
                  <div ref={locationRef}>{<Location {...data} />}</div>
            ...
            <div className="mt-8 flex flex-row">
               ...
               <div className="ml-6 min-h-fit">
                  ...
                  <p className="mt-1 w-9/12 font-poppins text-sm font-light text-[#909090]">
                     Pada saat moment kebersamaan kita,kita pesan 1 es,pas saya
                     lagi sendok es itu ke mulut, ,cuttttttttttt itu ngilu
                     nya,saya benar benar langsung kehilangan moment kebersamaan
                     sama sahabat sahabat saya,Dokter sarankan coba deh ibu
                     pakai sensodyne khusus untuk gigi yang sensitif,berkat
                     sensodyne,waaahhhhhh,, saya malah mungkin paling banyak
                     kali tuh kata temen temen,,... ehhh y&apos;oll pelan pelan
                     dong makannya kita belum kebagian nihh....,,mas es nya yang
                     banyak ya... dug dug..
                  </p>
                  <div className="mt-2 flex flex-row items-center space-x-4">
                     ...
                     <p className="mt-1 text-sm font-normal text-[#6E6E6E]">
                        20
                     </p>
                  </div>
