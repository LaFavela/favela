               ...
               <div className="w-[400px] h-[550px] bg-nila  rounded-lg shadow-xl flex flex-col">
                  ...
                  <form id="login" action="./footer" method="post" >
                     ...
                     <label htmlFor="password">
                        <span className="block mb-1 font-Poppins pl-11 mt-6">Password</span>
                        ...
                        <button type="submit" className="bg-gold rounded-full text-white font-semibold ml-9 mt-6 w-80 py-2 hover:bg-grayhov  transition duration-300 ease-in-out ">LOGIN</button>
                     </label>
                  </form>
                  <div className="flex justify-center mt-3 font-Poppins text-gray-400">
                     <p >or login with</p>
                  </div>
                  <div className="flex">
                     <form action="https://myaccount.google.com/personal-info" method="get">
                        <button className="border-2 border-red-500 rounded-full text-red-500 text-xl font-semibold ml-9 mt-3 w-[148px] py-2 hover:bg-gray-400 hover:border-gray-400 hover:text-black  transition duration-300 ease-in-out "><img src="/assets/login/google.png" alt="google" className="inline-block mr-5 mb-1" />Google</button>
                     </form>
                     <form action="https://www.facebook.com/" method="get">
                        <   button className="border-2 border-blue-500 rounded-full text-blue-500 text-xl font-semibold ml-6 mt-3 w-[148px] py-2 hover:bg-gray-400 hover:border-gray-400 hover:text-black  transition duration-300 ease-in-out "><img src="/assets/login/facebook.png" alt="facebook" className="inline-block mr-5 mb-1" />Facebook</button>
                     </form>
                  </div>
