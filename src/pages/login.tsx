...
export default function Login() {
   ...
   return (
      ...
      <div className="fixed inset-0 flex h-screen w-screen items-center justify-center">
         <div
            className="absolute left-0 top-0 h-full w-full bg-[#ffffffeb]"
         ></div>
         {!showRegister ? (
            // {/* Kotak Login */}
            <div className="z-50 flex h-[34.5rem] w-[54rem] justify-center rounded-[25px] bg-white border  opacity-100">
