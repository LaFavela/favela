            ...
            <div className="flex space-x-5">
               ...
               <div className="h-min w-5/12 flex flex-col">
                  ...
                  <p className="my-10 text-2xl font-extralight">Lorem ipsum dolor sit amet, consectetur adipisicing elit. In, aliquam porro. Maxime nesciunt quae veniam, quidem at fuga illum atque aperiam, cupiditate asperiores repellendus ducimus ratione architecto natus ipsam perferendis.
                     ...
                     Provident repudiandae nobis ipsam nesciunt voluptatum eaque amet debitis consectetur! Dolorem labore totam incidunt dolor placeat sapiente, neque reiciendis autem eligendi laudantium, sed sequi quod, atque error culpa nisi recusandae?</p>
                  <div className="flex flex-row space-x-4">
                     <button className="button-grey w-[142px]">
                        Sewa
                     </button>
               ...
               <nav className="sticky top-0 z-10 flex flex-col space-y-1 bg-white">
                  <div className="flex flex-row text-xl text-center text-[#D0D0D0]">
                     <div className="w-[175px] text-[#B17C3F]">
                        ...
                        <div className="border-b-8 rounded-full absolute border-[#B17C3F] w-[175px] z-10 mt-1"></div>
                     </div>
                     <div className="w-[325px]">
                        <button className="">Sarana & Prasarana</button>
                        <div className="border-b-8 rounded-full absolute border-[#D0D0D0] w-[325px] z-10 mt-1"></div>
                     </div>
                     <div className="w-[175px]">
                        <button className="">Lokasi</button>
                        <div className="border-b-8 rounded-full absolute border-[#D0D0D0] w-[175px] z-10 mt-1"></div>
                     </div>
                     <div className="w-[175px]">
                  ...
                  <div className="border-b-8 rounded-full border-[#D0D0D0] ">
                  </div>
               </nav>
               <div className="flex flex-col space-y-10 px-24 pt-9">
                  ...
                  <div className="">
                     ...
                     <div className="flex flex-row space-x-20">
                        <div className="flex flex-col space-y-2 pt-9 w-6/12">
                           <p className="text-sm font-medium text-grayhov">Tipe Properti</p>
                           <p className="text-lg font-medium">Villa</p>
                           <div className="flex flex-col space-y-3 relative border-b-2 rounded-full"></div>
                        </div>
                        <div className="flex flex-col space-y-2 pt-9 w-6/12">
                  ...
                  <div className="">
                     ...
                     <div className="flex flex-row space-x-20">
                        <div className="flex flex-row space-x-4 pt-9 w-6/12 items-center">
                           <ArrowLogo></ArrowLogo>
