...
const user = {
  ...
  job: [
    {
      id: 1,
      jobName: "IKEA Designer",
      jobAddress: "Jln. Seganteng Indah No 69 Blok 1945",
    },
    {
      id: 2,
      jobName: "Electronic Art Corp.",
      jobAddress: "Jln. Seganteng Indah No 69 Blok 1945",
    },
    {
      id: 2,
  ...
  website: "desainerterpercaya.com",
  socialMedia: "@bukanrehan",
};

const review = [
  {
    id: 1,
    reviewerName: "Dhira Wahyu Febrian",
    reviewAt: 3,
    reviewDescription:
      "lagi sendok es itu ke mulut, ,cuttttttttttt itu ngilu nya,saya benar benar langsung kehilangan moment kebersamaan sama sahabat sahabat saya,Dokter sarankan coba deh ibu pakai sensodyne khusus untuk gigi yang sensitif,berkat sensodyne,waaahhhhhh,, saya malah mungkin paling banyak kali tuh kata temen temen,,... ehhh y&apos;oll pelan pelan dong makannya kita belum kebagian nihh....,,mas es nya yang banyak ya... dug dug..",
    reviewerIMG: "/assets/profile/dhira.jpg",
    reviewTitle: "Keren banget",
    like: 20,
  },
  {
    id: 2,
    reviewerName: "Ali An Nuur",
    reviewAt: 3,
    reviewDescription:
    "lagi sendok es itu ke mulut, ,cuttttttttttt itu ngilu nya,saya benar benar langsung kehilangan moment kebersamaan sama sahabat sahabat saya,Dokter sarankan coba deh ibu pakai sensodyne khusus untuk gigi yang sensitif,berkat sensodyne,waaahhhhhh,, saya malah mungkin paling banyak kali tuh kata temen temen,,... ehhh y&apos;oll pelan pelan dong makannya kita belum kebagian nihh....,,mas es nya yang banyak ya... dug dug..",
    reviewerIMG: "/assets/profile/ali.jpg",
    reviewTitle: "Keren banget",
    like: 100,
  },
];
...
const project = [
  {
    id: 1,
    projectName: "Pesantren An - Nuur",
    projectDescription:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam vitae iusto expedita eos cum autem deserunt tempora voluptatum repellendus! Sint iste eveniet earum amet deserunt eligendi, minima reprehenderit consequuntur doloribus Lorem ipsum dolor sit, amet consectetur",
    projectIMG: "/assets/merchant/pesantren.jpg",
  },
  {
    id: 2,
    projectName: "Perumahan Payu",
    projectDescription:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam vitae iusto expedita eos cum autem deserunt tempora voluptatum repellendus! Sint iste eveniet earum amet deserunt eligendi, minima reprehenderit consequuntur doloribus Lorem ipsum dolor sit, amet consectetur",
    projectIMG: "/assets/merchant/Perumahan_Payu.jpg",
  },
  {
    id: 3,
    projectName: "Sekret Rental Pes",
    projectDescription:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam vitae iusto expedita eos cum autem deserunt tempora voluptatum repellendus! Sint iste eveniet earum amet deserunt eligendi, minima reprehenderit consequuntur doloribus Lorem ipsum dolor sit, amet consectetur",
    projectIMG: "/assets/merchant/sekret_RentalPes.jpg",
  },
];
...
const desain = [
  {
    id: 1,
    designName: "Rumah Minimalis",
    designDescription:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam vitae iusto expedita eos cum autem deserunt tempora voluptatum repellendus! Sint iste eveniet earum amet deserunt eligendi, minima reprehenderit consequuntur doloribus Lorem ipsum dolor sit, amet consectetur",
    designIMG: "/assets/merchant/Model2.jpg",
  },
  {
    id: 2,
    designName: "Rumah Ala Jepang",
    designDescription:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam vitae iusto expedita eos cum autem deserunt tempora voluptatum repellendus! Sint iste eveniet earum amet deserunt eligendi, minima reprehenderit consequuntur doloribus Lorem ipsum dolor sit, amet consectetur",
    designIMG: "/assets/merchant/Model1.jpg",
  },
  {
    id: 3,
    designName: "Rumah Minimalis",
  ...
  return (
    <div>
      ...
      {project.map((data, idx) => {
        return (
          <div key={idx} className="mr-5 mt-10 flex flex-row">
            <div className="mt-3 basis-1/2">
              <img
                src={data.projectIMG}
                alt="pesantren"
                className="h-[260px] w-[292px] rounded-3xl"
              />
            </div>
            <div className="ml-9 basis-11/12">
              <p className="text-[2rem] font-medium">{data.projectName}</p>
      ...
      {desain.map((data, idx) => {
        return (
          <div key={idx} className="mr-5 mt-10 flex flex-row">
            ...
            <div className="ml-9 basis-11/12">
              <p className="text-[2rem] font-semibold">{data.designName}</p>
              <p className="text-[1.15rem] font-extralight">
                {data.designDescription}
              </p>
              <button
                onClick={() => clickHandler("/product")}
                className="button-nila mt-6 w-36"
              >
                More
              </button>
            </div>
...
export function Properti() {
  return (
    <div>
      <div className="relative rounded-full border-b-8 border-gray-300 ">
        {/* <div className="absolute left-[30rem] top-0 w-[170px] rounded-full  border-b-8 border-[#B17C3F]"></div> */}
      </div>
      {desain.map((data, idx) => {
        return (
          <div key={idx} className="mr-5 mt-10 flex flex-row">
...
export function Kontak() {
  return (
    <div>
      <div className="relative rounded-full border-b-8 border-gray-300 ">
        {/* <div className="absolute left-[21.10rem] top-0 w-[170px] rounded-full  border-b-8 border-[#B17C3F]"></div> */}
      </div>
      <div className="mt-8  min-w-fit">
        <p className="text-[1.15rem] text-gray-400">Phone</p>
        <p className="pb-3 text-[1.4rem] font-medium "> {user.phone}</p>
        <svg
          width="837"
          height="2"
          viewBox="0 0 983 2"
      ...
      <div className="mt-8  min-w-fit">
        ...
        <p className="pb-3 text-[1.4rem] font-medium "> {user.email}</p>
        <svg
          width="837"
          height="2"
          viewBox="0 0 983 2"
      ...
      <div className="mt-8  min-w-fit">
        <p className="text-[1.15rem] text-gray-400">Site</p>
        <p className="pb-3 text-[1.4rem] font-medium "> {user.website}</p>
        <svg
          width="837"
          height="2"
          viewBox="0 0 983 2"
      ...
      <div className="mt-8  min-w-fit">
        <p className="text-[1.15rem] text-gray-400">Social Media</p>
        <p className="pb-3 text-[1.4rem] font-medium "> {user.socialMedia}</p>
        <svg
          width="837"
          height="2"
          viewBox="0 0 983 2"
...
export function Review() {
  ...
  return (
    <div>
      <div className="relative rounded-full border-b-8 border-gray-300 ">
        {/* <div className="absolute left-[31.57rem] top-0 w-[170px] rounded-full  border-b-8 border-[#B17C3F]"></div> */}
      </div>
            ...
            className="mt-8 flex flex-row">
              ...
              <div className="ml-6 min-h-fit">
                <div className="mt-1 flex flex-row items-center space-x-2">
                  <p className="text-lg font-normal">{data.reviewerName}</p>
                  <p className="mt-1 text-xs font-extralight">{data.reviewAt} minutes ago</p>
                </div>
                <svg
                  width="74"
                  height="11"
                ...
                <p className="mt-3 text-sm">{data.reviewTitle}</p>
                ...
                <div className="mt-2 flex flex-row items-center space-x-4">
                  ...
                  <p className="mt-1 text-sm font-normal text-[#6E6E6E]">{data.like}</p>
                </div>
      ...
      <p className="font-poppins text-[20px]">Write Review</p>
      <p className="mt-3 font-poppins text-[17px]">
        how much do you like to {user.firstName}
      </p>
...
export default function merchantProfile() {
  ...
  const [currentFunction, setCurrentFunction] = useState<
    "Kontak" | "Project" | "Design" | "Property" | "Review"
  >("Kontak");
  const [activeButton, setActiveButton] = useState<
    "Kontak" | "Project" | "Design" | "Property" | "Review"
  >("Kontak");
  const handleFunctionChange = (
    functionName: "Kontak" | "Project" | "Design" | "Property" | "Review"
  ) => {
    ...
    <div className="flex justify-center mt-10">
      <div className="w-10/12 ">
        <div className="flex flex-row  ">
          ...
          <div className="ml-20 mt-3 flex basis-[93%] flex-row">
            <div className="basis-[75%]">
              <div className="flex items-center  space-x-3">
                <p className="ml-2 text-[2.1rem] font-medium">
                  {user.firstName} {user.lastName}
                </p>
                <p className="flex h-[28px] w-[112px] items-center justify-center rounded-full bg-[#E3D0BA] text-xs text-[#B17C3F]">
                  {" "}
                  {user.role}{" "}
                </p>
              </div>
              <p className="ml-2 text-[1.2rem] text-gray-400">
              ...
              <div className="mt-2 flex flex-row">
                ...
                <p className="ml-2 mt-[0.18rem] text-[1.1rem] font-medium">
                  {user.jumlahUlasan} Review
                </p>
              </div>
              <div className="mt-3 flex flex-row">
                ...
                <p className="ml-2 text-[20px] font-medium">
                  {calculate(user.follower)} Follower
                </p>
              </div>
              <p className="ml-2 mt-5 text-[1.25rem] font-light">
                {user.userDescription}
              </p>
              <div className="mt-[4.5rem] flex flex-row space-x-5 ">
                <button className="button-grey w-[178px]">Message</button>
                <button className="button-brown w-[200px]">Call</button>
              </div>
            </div>

            <div className="mr-7 mt-[1.30rem] flex basis-1/4 place-content-end">
              <svg
                width="31"
                height="26"
                viewBox="0 0 31 26"
              ...
              >
                <path
                  d="M15.4805 24.4857L4.04624 14.1286C-2.16804 7.91428 6.96696 -4.01714 15.4805 5.63571C23.9941 -4.01714 33.0877 7.95571 26.9148 14.1286L15.4805 24.4857Z"
                  stroke="black"
                  stroke-width="3"
                  stroke-linecap="round"
                  stroke-linejoin="round"
        ...
        {/* pembatas */}
        <div className="mt-16 flex flex-row pb-8  ">
          <div className="basis-1/2">
            <div className="flex flex-col space-x-8">
              <div className="ml-8 mt-10 flex flex-row">
                <p className="mt-1 pr-4 text-[1.1rem] text-gray-400">Job</p>
                <svg
                  width="320"
                  height="2"
                  viewBox="0 0 379 2"
              ...
              {user.job.map((data, idx) => {
                return (
                  <div key={idx}>
                    <div className="flex flex-row space-x-9 space-y-5">
                      <p className="mt-4 text-[1.4rem] font-semibold">
                        {data.jobName}
                      </p>
                      {idx === 0 ? (
                        <p className="flex h-[28-x] w-[112px] items-center justify-center rounded-full bg-[#E3D0BA] text-xs text-[#B17C3F]">
                          {" "}
                          Main Job{" "}
                        </p>
                      ) : (
                    ...
                    <p className="mt-3 text-[1.1rem] text-gray-400">
                      {data.jobAddress}
                    </p>
                  </div>
                );
          ...
          <div className="ml-14 mt-[1.15rem] basis-11/12 ">
            <button
              onClick={() => handleFunctionChange("Kontak")}
              className={`w-[170px] text-[1.4rem] ${
                activeButton === "Kontak" ? "text-[#B17C3F]" : "text-gray-400"
              }`}
            >
              Contact
            </button>
            {user.role==="TUKANG"?(
               <button
               onClick={() => handleFunctionChange("Project")}
               className={`w-[170px] text-[1.4rem] ${
                  activeButton === "Project" ? "text-[#B17C3F]" : "text-gray-400"
               }`}
               >
               Project
               </button>
            ...
            {user.role==="DESAINER"?(
               ...
               className={`w-[170px] text-[1.4rem] ${
                 activeButton === "Design" ? "text-[#B17C3F]" : "text-gray-400"
               }`}
               >
               Design{" "}
               </button>
            ...
            {user.role==="PENJUAL"?(
               <button
               onClick={() => handleFunctionChange("Property")}
               className={`w-[170px] text-[1.4rem] ${
                 activeButton === "Property" ? "text-[#B17C3F]" : "text-gray-400"
               }`}
             >
               Property{" "}
             </button>
            ...
            <button
              onClick={() => handleFunctionChange("Review")}
              className={`w-[170px] text-[1.4rem] ${
                activeButton === "Review" ? "text-[#B17C3F]" : "text-gray-400"
              }`}
            >
              Review
            </button>
            ...
            {currentFunction === "Design" && <Desain />}
            {currentFunction === "Property" && <Properti />}
