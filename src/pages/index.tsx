   ...
   return (
      <div>
         ...
         <div className="flex flex-col justify-center items-center mt-28">
            <p className="text-[2.2rem] font-medium">The <span className="text-[#B17C3F]">Service</span>  You Get From <span className="text-[#B17C3F]">Favela</span></p>
         ...
         <div className="flex flex-row items-center justify-center mt-16 gap-8 pb-10">
            <div className="w-[18.3rem] h-[18.3rem] rounded-[1.5625rem] bg-white drop-shadow-landingShado ">
               <div className="flex flex-row mt-5 ml-7">
                  <p className="text-[1.2rem] font-medium mt-12">Buy Properties</p>
                  <div className=" w-20 h-20 bg-gray-200 rounded-full drop-shadow-none ml-5 flex items-center justify-center">
                     <svg width="45" height="44" viewBox="0 0 54 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M42 32C42 33.1935 41.5259 34.3381 40.682 35.182C39.8381 36.0259 38.6935 36.5 37.5 36.5C36.3065 36.5 35.1619 36.0259 34.318 35.182C33.4741 34.3381 33 33.1935 33 32C33 30.8065 33.4741 29.6619 34.318 28.818C35.1619 27.9741 36.3065 27.5 37.5 27.5C38.6935 27.5 39.8381 27.9741 40.682 28.818C41.5259 29.6619 42 30.8065 42 32Z" fill="white" />
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M5.439 10.184L38.439 0.755048C39.5553 0.436013 40.7304 0.380481 41.8718 0.592825C43.0132 0.80517 44.0897 1.27959 45.0165 1.97873C45.9434 2.67787 46.6953 3.58264 47.213 4.62178C47.7307 5.66093 48.0001 6.80608 48 7.96705V11C49.5913 11 51.1174 11.6322 52.2426 12.7574C53.3679 13.8826 54 15.4087 54 17V47C54 48.5913 53.3679 50.1175 52.2426 51.2427C51.1174 52.3679 49.5913 53 48 53H6C4.4087 53 2.88258 52.3679 1.75736 51.2427C0.632141 50.1175 0 48.5913 0 47V17C0 13.865 2.505 11.021 5.439 10.184ZM40.089 6.52405C40.312 6.46052 40.5467 6.44955 40.7746 6.49199C41.0025 6.53444 41.2175 6.62914 41.4027 6.76868C41.5879 6.90821 41.7382 7.08877 41.8418 7.29618C41.9455 7.50358 41.9996 7.73219 42 7.96405V11H24.42L40.089 6.52405ZM6 17H48V47H6V17Z" fill="white" />
                     </svg>
                  </div>
               </div>
               <p className="text-[0.7rem] ml-7 mt-3 pr-10">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                  incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud
                  exercitation ullamco laboris nisi ut aliquip ex ea commodo
               </p>
               <button className="w-[2rem] h-[2rem] bg-[#B17C3F] rounded-full mt-2 ml-7">
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="ml-[0.44rem]">
                     <path d="M9 17.5L6 14.5L9.5 11H0V7H9.5L6 2.5L9 0L17.5 9L9 17.5Z" fill="white" />
                  </svg>
            ...
            <div className="w-[18.3rem] h-[18.3rem] rounded-[1.5625rem] bg-white drop-shadow-landingShado">
               <div className="flex flex-row mt-5 ml-7">
                  <p className="text-[1.2rem] font-medium mt-12">Sell Properties</p>
                  <div className=" w-20 h-20 bg-gray-200 rounded-full drop-shadow-none ml-5 flex items-center justify-center">
                     <svg width="56 " height="56" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M53.7266 62.1807V42.1724C53.7261 39.5814 53.2151 37.0159 52.2229 34.6224C51.2307 32.2289 49.7767 30.0544 47.944 28.2229L42.4487 22.7277V41.2903C42.4487 43.7984 39.4136 45.0581 37.6383 43.2827L33.9889 39.6361C32.5798 38.2271 29.1953 37.3817 26.938 39.6361C24.6836 41.8906 25.529 45.2723 26.938 46.6813L42.4487 62.1807" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M31.1819 5.81921H36.818C38.3128 5.81921 39.7464 6.41302 40.8034 7.47C41.8604 8.52699 42.4542 9.96056 42.4542 11.4554V17.0915M31.1819 5.81921C31.1819 9.57571 33.4363 17.0915 42.4542 17.0915M31.1819 5.81921H25.5457M42.4542 17.0915V34M25.5457 5.81921H19.9096C18.4148 5.81921 16.9812 6.41302 15.9242 7.47C14.8672 8.52699 14.2734 9.96056 14.2734 11.4554V17.0915M25.5457 5.81921C25.5457 9.57571 23.2913 17.0915 14.2734 17.0915M14.2734 34V39.6361C14.2734 41.1309 14.8672 42.5645 15.9242 43.6215C16.9812 44.6785 18.4148 45.2723 19.9096 45.2723H25.5457C25.5457 41.5158 23.2913 34 14.2734 34ZM14.2734 34V17.0915" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M25.546 25.5457C25.546 27.1021 26.8077 28.3638 28.3641 28.3638C29.9204 28.3638 31.1821 27.1021 31.1821 25.5457C31.1821 23.9894 29.9204 22.7277 28.3641 22.7277C26.8077 22.7277 25.546 23.9894 25.546 25.5457Z" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                     </svg>
            ...
            <div className="w-[18.3rem] h-[18.3rem] rounded-[1.5625rem] bg-white drop-shadow-landingShado">
               <div className="flex flex-row mt-5 ml-7">
                  <p className="text-[1.2rem] font-medium mt-12">Rent Properties</p>
                  <div className=" w-20 h-20 bg-gray-200 rounded-full drop-shadow-none ml-5 flex items-center justify-center">
                     <svg width="48" height="42" viewBox="0 0 56 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M47.7867 15.625L49.6533 25H6.34667L8.21333 15.625H47.7867ZM52.8889 0H3.11111V6.25H52.8889V0ZM52.8889 9.375H3.11111L0 25V31.25H3.11111V50H34.2222V31.25H46.6667V50H52.8889V31.25H56V25L52.8889 9.375ZM9.33333 43.75V31.25H28V43.75H9.33333Z" fill="white" />
                     </svg>
         ...
         <div className="flex flex-col justify-center items-center mt-28 pb-28">
            <p className="text-[2.2rem] font-medium">We Provide The <span className="text-[#B17C3F]">Base Based</span> On </p>
            <p className="text-[2.2rem] font-medium">The <span className="text-[#B17C3F]">Property</span> You Like </p>
            <div className="w-[44.6rem]">
               <p className="text-center mt-4 text-sm">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit,
         ...
         <div className="grid grid-cols-3 gap-y-10">
            <div className="w-[20.75rem] h-[24rem] rounded-[1.5625rem] ml-[8.5rem] relative">
               <img src="/assets/landing/build1.jpg" alt="build1" className="w-[20.75rem] h-[24rem] rounded-[1.5625rem]" />
               <div className="rounded-[1.5625rem] absolute inset-0 flex bg-black bg-opacity-25 opacity-0 hover:opacity-100 transition-opacity ease-in-out duration-500">
                  <div className='flex absolute justify-between inset-0'>
                     <div className="flex ml-5 mt-5">
                        <div className="h-8 w-24 border-2 border-white rounded-full flex justify-center items-center">
                           <p className="text-white text-[0.75rem] font-medium">Rumah</p>
                        </div>
                     </div>
                     <div className="mr-5 mt-5">
                        <button onClick={handleButtonClick}>
                           <svg width="34" height="28" viewBox="0 0 38 32" fill={isPressed ? 'white' : 'none'} xmlns="http://www.w3.org/2000/svg">
                              <path d="M19.0107 30L4.58209 17.1029C-3.25953 9.36467 8.26766 -5.49276 19.0107 6.52732C29.7537 -5.49276 41.2286 9.41626 33.4393 17.1029L19.0107 30Z" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                           </svg>
                        </button>
                     </div>
                  </div>
                  <div className='flex items-end'>
                     <Link href={"./product"} className="h-[2.5rem] w-[2.5rem] rounded-full mb-5 ml-5  absolute">
            ...
            <div className="w-[20.75rem] h-[24rem] rounded-[1.5625rem] ml-[4rem] relative">
               <img src="/assets/landing/build2.jpg" alt="build2" className="w-[20.75rem] h-[24rem] rounded-[1.5625rem]" />
               <div className="rounded-[1.5625rem] absolute inset-0 flex bg-black bg-opacity-25 opacity-0 hover:opacity-100 transition-opacity ease-in-out duration-500">
                  <div className='flex absolute justify-between inset-0'>
                     <div className="flex ml-5 mt-5">
                        <div className="h-8 w-24 border-2 border-white rounded-full flex justify-center items-center">
            ...
            <div className="w-[20.75rem] h-[24rem] rounded-[1.5625rem] ml-[1] relative">
               <img src="/assets/landing/build3.jpg" alt="build3" className="w-[20.75rem] h-[24rem] rounded-[1.5625rem]" />
               <div className="rounded-[1.5625rem] absolute inset-0 flex bg-black bg-opacity-25 opacity-0 hover:opacity-100 transition-opacity ease-in-out duration-500">
                  <div className='flex absolute justify-between inset-0'>
                     <div className="flex ml-5 mt-5">
                        <div className="h-8 w-24 border-2 border-white rounded-full flex justify-center items-center">
            ...
            <div className="w-[20.75rem] h-[24rem] rounded-[1.5625rem] ml-[8.5rem] relative">
               <img src="/assets/landing/build4.jpg" alt="build4" className="w-[20.75rem] h-[24rem] rounded-[1.5625rem]" />
               <div className="rounded-[1.5625rem] absolute inset-0 flex bg-black bg-opacity-25 opacity-0 hover:opacity-100 transition-opacity ease-in-out duration-500">
                  <div className='flex absolute justify-between inset-0'>
                     <div className="flex ml-5 mt-5">
                        <div className="h-8 w-24 border-2 border-white rounded-full flex justify-center items-center">
            ...
            <div className="w-[20.75rem] h-[24rem] rounded-[1.5625rem] ml-[4rem] relative">
               <img src="/assets/landing/build5.jpg" alt="build5" className="w-[20.75rem] h-[24rem] rounded-[1.5625rem]" />
               <div className="rounded-[1.5625rem] absolute inset-0 flex bg-black bg-opacity-25 opacity-0 hover:opacity-100 transition-opacity ease-in-out duration-500">
                  <div className='flex absolute justify-between inset-0'>
                     <div className="flex ml-5 mt-5">
                        <div className="h-8 w-24 border-2 border-white rounded-full flex justify-center items-center">
            ...
            <div className="w-[20.75rem] h-[24rem] rounded-[1.5625rem] ml-[1] relative">
               <img src="/assets/landing/build6.jpg" alt="build6" className="w-[20.75rem] h-[24rem] rounded-[1.5625rem]" />
               <div className="rounded-[1.5625rem] absolute inset-0 flex bg-black bg-opacity-25 opacity-0 hover:opacity-100 transition-opacity ease-in-out duration-500">
                  <div className='flex absolute justify-between inset-0'>
                     <div className="flex ml-5 mt-5">
                        <div className="h-8 w-24 border-2 border-white rounded-full flex justify-center items-center">
         ...
         <div className="flex flex-col justify-center items-center mt-28 pb-20 ">
            <p className="text-[2.2rem] font-medium">Start <span className="text-[#B17C3F]">Consult Or Buy</span> A Design </p>
            <p className="text-[2.2rem] font-medium">From The<span className="text-[#B17C3F]"> Designer</span></p>
            <div className="w-[44.6rem]">
               <p className="text-center mt-4 text-sm">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                  sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
         ...
         <div className='grid grid-cols-3 pb-28'>
            <div className="w-[20.75rem] h-[24rem] rounded-[1.5625rem] ml-[8.5rem] relative">
               <img src="/assets/landing/Designer1.jpg" alt="Designer 1" className="w-[20.75rem] h-[24rem] rounded-[1.5625rem] object-cover" />
               <div className="rounded-[1.5625rem] absolute inset-0 flex bg-black bg-opacity-25 opacity-0 hover:opacity-100 transition-opacity ease-in-out duration-500">
                  <div className='flex absolute justify-between inset-0'>
                     <div className="flex ml-5 mt-5">
                        <p className='text-white font-semibold text-[1.3rem]'>Paper Pot</p>
                     </div>
                     <div className="mr-5 mt-5">
                        <button onClick={handleButtonClick}>
                           <svg width="34" height="28" viewBox="0 0 38 32" fill={isPressed ? 'white' : 'none'} xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-[20.75rem] h-[24rem] rounded-[1.5625rem] ml-[4rem] relative">
               <img src="/assets/landing/Designer2.jpg" alt="Designer 2" className="w-[20.75rem] h-[24rem] rounded-[1.5625rem] object-cover" />
               <div className="rounded-[1.5625rem] absolute inset-0 flex bg-black bg-opacity-25 opacity-0 hover:opacity-100 transition-opacity ease-in-out duration-500">
                  <div className='flex absolute justify-between inset-0'>
                     <div className="flex ml-5 mt-5">
                        <p className='text-white font-semibold text-[1.3rem]'>Freya</p>
                     </div>
                     <div className="mr-5 mt-5">
                        <button onClick={handleButtonClick}>
                           <svg width="34" height="28" viewBox="0 0 38 32" fill={isPressed ? 'white' : 'none'} xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className='flex items-end'>
                     <button className='h-[2.5rem] w-[2.5rem] rounded-full mb-5 ml-5  absolute'>
                        <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                           <path
                              d="M22 30.8L30.8 22L22 13.2L18.92 16.28L22.44 19.8H13.2V24.2H22.44L18.92 27.72L22 30.8ZM22 44C18.9567 44 16.0967 43.4221 13.42 42.2664C10.7433 41.1107 8.415 39.5435 6.435 37.565C4.455 35.585 2.88787 33.2567 1.7336 30.58C0.579334 27.9033 0.00146667 25.0433 0 22C0 18.9567 0.577867 16.0967 1.7336 13.42C2.88933 10.7433 4.45647 8.415 6.435 6.435C8.415 4.455 10.7433 2.88787 13.42 1.7336C16.0967 0.579334 18.9567 0.00146667 22 0C25.0433 0 27.9033 0.577867 30.58 1.7336C33.2567 2.88933 35.585 4.45647 37.565 6.435C39.545 8.415 41.1129 10.7433 42.2686 13.42C43.4243 16.0967 44.0015 18.9567 44 22C44 25.0433 43.4221 27.9033 42.2664 30.58C41.1107 33.2567 39.5435 35.585 37.565 37.565C35.585 39.545 33.2567 41.1129 30.58 42.2686C27.9033 43.4243 25.0433 44.0015 22 44Z"
                              className="fill-white hover:fill-gray-200"
            ...
            <div className="w-[20.75rem] h-[24rem] rounded-[1.5625rem] ml-[1] relative">
               <img src="/assets/landing/Designer3.jpg" alt="Designer 3" className="w-[20.75rem] h-[24rem] rounded-[1.5625rem] object-cover" />
               <div className="rounded-[1.5625rem] absolute inset-0 flex bg-black bg-opacity-25 opacity-0 hover:opacity-100 transition-opacity ease-in-out duration-500">
                  <div className='flex absolute justify-between inset-0'>
                     <div className="flex ml-5 mt-5">
                        <p className='text-white font-semibold text-[1.3rem]'>Antonio Rudiger</p>
                     </div>
                     <div className="mr-5 mt-5">
                        <button onClick={handleButtonClick}>
                           <svg width="34" height="28" viewBox="0 0 38 32" fill={isPressed ? 'white' : 'none'} xmlns="http://www.w3.org/2000/svg">
         ...
         <div className="flex flex-col justify-center items-center mt-5 pb-20 ">
            <p className="text-[2.2rem] font-medium"><span className="text-[#B17C3F]">This</span> Is What Theres have <span className="text-[#B17C3F]">To Say</span></p>
            <div className="w-[44.6rem]">
               <p className="text-center mt-4 text-sm">
