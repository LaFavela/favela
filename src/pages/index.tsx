...
>) {
	...
	return (
		<div className=" transition-all duration-300 ease-linear min-h-screen">
			<Head>
			...
			{isLoading ? (
				<div className="container mx-auto max-w-md sm:max-w-xl xl:max-w-5xl 2xl:max-w-7xl">
					...
					<div className=" mt-12 space-y-1 flex justify-center">
					...
					<div className=" flex mt-12 flex-grow flex-row justify-center gap-10 pl-7 pr-7">
						<Skeleton
							variant="rounded"
							className="rounded-xl"
							width={281}
				...
				<div className="container mx-auto max-w-md sm:max-w-xl xl:max-w-5xl 2xl:max-w-7xl">
					...
					<div className=" mt-6 flex flex-col items-center justify-center">
						...
						<p className="w-[280px] text-center text-[5px] xl:mt-3 xl:w-[655px] xl:text-[12px] 2xl:w-[820px] 2xl:text-[15px]">
							There is a wide range of services we provide to help you build
							your dream property.
						</p>
					</div>
					...
					<div className="mt-8 flex justify-center space-x-10">
						<div className=" container h-24 w-24 rounded-md bg-white drop-shadow-landingShado  xl:h-[215px] xl:w-[215px] xl:rounded-3xl 2xl:h-[281px] 2xl:w-[281px]">
							...
							<p className="px-2 text-[5px] xl:mt-1 xl:px-5 xl:text-[10px] 2xl:px-8 2xl:text-[14px]">
								...
								architect according to location, design style and property
								style. View portfolios, read reviews, and contact directly for
								your project
							</p>
						</div>
						...
						<div className=" container h-24 w-24 rounded-md bg-white drop-shadow-landingShado  xl:h-[215px] xl:w-[215px] xl:rounded-3xl 2xl:h-[281px] 2xl:w-[281px]">
							...
							<p className="px-2 text-[5px] xl:mt-1 xl:px-5 xl:text-[10px] 2xl:px-8 2xl:text-[14px]">
								...
								designs from trusted designers. Search for a design you like,
								view the details, and buy the design that fits your project
							</p>
						</div>
						...
						<div className=" container h-24 w-24 rounded-md bg-white drop-shadow-landingShado  xl:h-[215px] xl:w-[215px] xl:rounded-3xl 2xl:h-[281px] 2xl:w-[281px]">
							...
							<p className="px-2 text-[5px] xl:mt-1 xl:px-5 xl:text-[10px] 2xl:px-8 2xl:text-[14px]">
								...
								advice, and start planning your dream home project with
								confidence
							</p>
						</div>
						...
						<div className=" container h-24 w-24 rounded-md bg-white drop-shadow-landingShado  xl:h-[215px] xl:w-[215px] xl:rounded-3xl 2xl:h-[281px] 2xl:w-[281px]">
							...
							<p className="px-2 text-[7px] xl:mt-1 xl:px-5 xl:text-[10px] 2xl:px-8 2xl:text-[14px]">
								...
								properties. Find a property that suits you, view the details,
								and start planning the construction of your dream home
							</p>
						</div>
					</div>
							...
							return (
								<div key={idx} className="">
									<div className="relative flex-auto gap-20">
										<Image
											src={
												designerData.avatar_url != null
													? designerData.avatar_url
													: ""
											}
											alt=""
											height={315}
											...
											<div className="absolute inset-0 flex justify-between">
												<div className="ml-5 mt-5 flex">
													<p className="text-[1.3rem] font-semibold text-white">
														{designerData.first_name
															? designerData.first_name
															: ""}{" "}
														{designerData.last_name
															? designerData.last_name
															: ""}
													</p>
												</div>
