      ...
      <div id="details" className="">
        ...
        <div className="flex flex-row space-x-20">
          ...
          <div className="flex w-6/12 flex-col space-y-2 pt-9">
            ...
            <p className="text-lg font-medium">1 Jam yang Lalu </p>
            <div className="relative flex flex-col space-y-3 rounded-full border-b-2"></div>
          </div>
        </div>
        <div className="flex w-full flex-col space-y-2 pt-9">
          <p className="text-sm font-medium text-grayhov">Deskripsi Fitur</p>
          <p className="text-lg font-medium">
            Lorem ipsum dolor sit amet consectetur adipisicing elit.
            Reprehenderit at temporibus cum nam fugit, ut veniam nulla tenetur
            eligendi aliquam, distinctio, eos quas. Vel minus, amet tempora odit
            ab obcaecati Lorem ipsum, dolor sit amet consectetur adipisicing
            elit. Consequatur sit labore magni ratione quis. Et voluptas
            sapiente, quibusdam tempore at beatae. Perferendis eum alias et
            eveniet facilis odit eos iure! Lorem ipsum dolor sit amet
            consectetur adipisicing elit. Adipisci labore cum incidunt dicta
            necessitatibus quaerat debitis non molestias placeat sint. Iusto
            eveniet magni ab cupiditate asperiores dolores repellat corporis
            error.{" "}
          </p>
          <div className="relative flex flex-col space-y-3 rounded-full border-b-2"></div>
        </div>
        <div className="relative mt-10 flex flex-row gap-10 space-y-3 border-b-2">
          {/* disini denah */}
          {denah.map((denah, idx) => {
            return (
              <div key={idx} className="pb-10">
                {idx == 0 ? (
                  ...
                  <Image height={36} width={36} src={denah} alt="" />
                )}
              </div>
            );
          })}
      ...
      <div className="flex-warp flex flex-col space-y-5 p-12">
        ...
        <div className="flex space-x-10">
          ...
          <div className="flex h-min w-[45%] flex-col">
            <p className="mt-3 text-[1.75rem] font-medium">Rumah Minimalis</p>
