...
export default function Browse() {
  ...
  const [activeButton, setActiveButton] = useState<"Buy" | "Rent">(
    "Buy"
  );
          ...
          <div className="h-12 w-56">
            <Listbox value={selectedPerson} onChange={setSelectedPerson}>
              <Listbox.Button
                ...
                className={`h-full w-full cursor-default rounded-3xl py-2 pl-3 pr-10 text-left font-light text-[#9ca3af] sm:text-xl ${
                  isClick ? "bg-[#E4D1BC]" : "bg-[#F1F1F1]"
                }`}
              >
                <div className="flex w-max">
                  <span className="w-[11rem]">
                    {selectedPerson ? selectedPerson.name : "Choose Type"}
                  </span>
              ...
              >
               ...
               relative ml-1 mr-1 cursor-pointer select-none rounded-xl py-2 pl-10 pr-4`
                      }
                    >
                      {person.name}
                    </Listbox.Option>
